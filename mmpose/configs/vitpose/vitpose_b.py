_base_ = [
    ...
    'mmpose/_base_/datasets/ieee_vip_cup_2021.py', 
]

data_root = '/home/yoonchul/Documents/personal_work/SomniAI/data/converted-ieee-vip-cup-2021'     
...
train_pipeline = [
    ...
    dict(type='TopDownHalfBodyTransform', num_joints_half_body=7, prob_half_body=0.3),
...
ann_file  = f'{data_root}/vipcup2021_coco.json'
