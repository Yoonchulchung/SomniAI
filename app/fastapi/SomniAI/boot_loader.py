...
from SomniAI.AI import ModelLoader
...
def bootstrap() -> ProcessGPU:
    ...
    SomniAI_cfg = get_cfg()
    gpu = ProcessGPU(SomniAI_cfg.AI, Inference, Dataset, SomniAI_log)
    
    model_loader = ModelLoader(SomniAI_cfg.AI.FREE_MEM_THRESHOLD,
